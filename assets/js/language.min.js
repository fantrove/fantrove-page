 ...
 * - หากการแปลไม่ระบุการจัดวาง SVG ใด ๆ (ไม่มี @svg@/@lsvg@ และไม่มี <svg> ในเนื้อหาแปล) ระบบจะคาดคะเนและแทรก marker แบบ internal (lsvg) ที่ตำแหน่งเริ่มต้นของเนื้อหา (front-most)
 * - หากมีการระบุ @lsvg@ ในสตริงแปล จะยึดตำแหน่งนั้น (แต่ยังคงความพยายามในการ preserve identity ของ <svg>)
 ...
 * - this.enforcePathLangPrefix: เมื่อเป็น true การเรียก updatePageLanguage จะพยายามปรับ URL ให้มี language prefix ใน path (เช่น /th/...)
 ...
 * - ถ้าไม่มีข้อมูลใด ๆ แต่ DOM มี <svg> อยู่แล้ว ระบบจะ "คาดคะเน" ว่า svg ตัวแรก (หรือที่ match ตาม id) ควรถูกย้าย/preserve
 *
