...
Con-Data คือคลังข้อมูลของเว็บ — ที่เก็บอีโมจิ สัญลักษณ์ ข้อความแฟนซี และ AI tool cards ทั้งหมด เป็นชั้นกลางระหว่างข้อมูลจริงกับส่วนที่แสดงผล ทำให้เวลาเพิ่มข้อมูลใหม่ ๆ ไม่ต้องแก้โค้ดหลายที่ เพียงแค่เพิ่มไฟล์ข้อมูลแล้วระบบจะรู้จักอัตโนมัติ
