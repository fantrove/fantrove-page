...
|---|---|---|
| Emojipedia | Content depth, brand authority | Multi-language parity — เราดัน SEO ทุกภาษาที่รองรับเท่ากัน ไม่เลือกภาษาใดภาษาหนึ่ง |
| SymbolKeyboard | Speed, simple UX | Performance + structured data + multi-language |
| Fancy Text Generator | Domain age, backlinks | Technical SEO + content freshness + multi-language |
...
### 1.4 Multi-language SEO Strategy
...
| สิ่งที่ต้องทำ | ต้องทำให้ **ทุกภาษา** |
|---|---|
| Meta tags (`title`, `description`) | ✅ แปลให้ครบทุกภาษา ไม่ใช่แค่ภาษาหลัก |
| hreflang tags | ✅ ครบทุกภาษาในทุกหน้า (รวม self-reference + x-default) |
| Canonical URLs | ✅ แต่ละภาษามี canonical ของตัวเอง |
| Open Graph + Twitter Card | ✅ แปล title/description ให้ครบ |
| Structured data (JSON-LD) | ✅ ใช้ `inLanguage` ระบุภาษาที่ถูกต้อง |
| Sitemap entries | ✅ ทุกหน้า × ทุกภาษา |
| Translation quality | ✅ ไม่ใช้ machine translation ลอย ๆ — ต้อง review โดย native speaker |
| Core Web Vitals | ✅ ทดสอบทุกภาษา (translation ไม่ควรทำให้ layout shift) |
| Content freshness | ✅ อัปเดตพร้อมกันทุกภาษา |

#### 1.4.2 การตัดสินใจเมื่อมี limited resources

ถ้ามีเวลา/ทรัพยากรจำกัด ห้ามเลือก "ภาษาไทยก่อน" หรือ "ภาษาอังกฤษก่อน" — ให้เลือกตาม **data** แทน:

1. ดู Google Search Console → Performance → ดู queries/clicks ของแต่ละภาษา
2. ดูหน้าที่มี potential สูงในแต่ละภาษา
3. prioritize ตาม impact ไม่ใช่ตามความคุ้นเคยของทีม

#### 1.4.3 เมื่อเพิ่มภาษาใหม่

ต้องทำครบทุกข้อเท่ากับภาษาเดิม ดู section 4.4 "เมื่อเพิ่มภาษาใหม่" สำหรับ checklist เต็ม
